...
local XCommands = 
{
    LockCommand = "k", -- The command to lock the link sharing
    UnlockCommand = "u", -- The command to unlock the link sharing
    CheckCommand = "?" -- The command to check for the statue of the link sharing
}

local msgs = 
{
    already_locked = "الــروابــط مقفــوله بالفــعل .. لتــلزك 🔐", -- the message that sent when you try to lock the sharing and it's already locked
    Locked = "تــم قفــل الروابـــط 🔒", -- the message that send when you lock the sharing

    already_unlocked = "الــروابـط مفــوحه بالفــعل .. لتلــزك 🔐", -- the message that sent when you try to unlock the sharing and it's already unlocked
    UnLocked = "تــم فتــح الروابــط 🔓", -- the message that send when you unlock the sharing
